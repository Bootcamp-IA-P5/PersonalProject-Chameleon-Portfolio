    ...
    return (
        <div
            className="group relative glass glass-hover rounded-2xl p-6 md:p-8 transition-all duration-300
                 hover:glow-cyan animate-fade-up"
        ...
        >
            <div className="flex gap-6 md:gap-8 overflow-hidden">
                ...
                <div className="flex-1 flex flex-col min-w-0">
                    ...
                    <span
                        className={`inline-flex items-center self-start text-[10px] font-bold uppercase tracking-widest
                            px-2.5 py-1 rounded-full border ${categoryStyle} mb-4 whitespace-nowrap`}
                    >
                        {project.category}
                    </span>

                    {/* Title */}
                    <h3 className="text-xl font-bold text-white mb-2 leading-snug group-hover:text-cyan-50 transition-colors line-clamp-2">
                        {project.title}
                    </h3>

                    {/* Description */}
                    <p className="text-slate-400 text-sm leading-relaxed mb-4 flex-1 line-clamp-3 md:line-clamp-none">
                ...
                {/* Right: Score bar */}
                <div className="flex flex-col items-center w-24 md:w-32 shrink-0 border-l border-slate-800/60 pl-6 md:pl-8">
